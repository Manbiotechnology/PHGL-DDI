...
def main():
    ...
    if config['aug'] == 'node':
        from dataset_NodeEdge import MoleculeDatasetWrapper
    elif config['aug'] == 'subgraph':
        from dataset_subgraph_node import MoleculeDatasetWrapper
    elif config['aug'] == 'mix':
        from dataset_subgraph_NodeEdge import MoleculeDatasetWrapper
    else:
